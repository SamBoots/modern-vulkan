...
namespace BB
{
	...
	/// <param name="a_ReserveSize:"> How much extra memory is reserved for possible resizes. Default is VIRTUAL_RESERVE_STANDARD, which will reserve 128 times more virtual space (32 times more on x86).</param>
