...
namespace BB
{
    ...
    public:
        ...
        bool Reset();
        bool LoadLuaFile(MemoryArena& a_temp_arena, const StringView& a_file_path);
        ...
        bool LoadBuffer(Buffer a_string);
        ...
        bool CallFunction(lua_CFunction a_function, const int a_nargs, const int a_nresults);
