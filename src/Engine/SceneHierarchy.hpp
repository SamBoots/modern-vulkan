...
namespace BB
{
	...
	public:
		...
		void DrawSceneHierarchy(const RCommandList a_list, UploadBufferView& a_upload_buffer_view, const RenderTarget a_render_target, const uint2 a_draw_area_size, const int2 a_draw_area_offset) const;
