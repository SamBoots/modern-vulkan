...
namespace BB
{
	...
	AttributeGPUBufferView AllocateFromVertexBufferGeometry(const size_t a_size_in_bytes);
	AttributeGPUBufferView AllocateFromVertexBufferShading(const size_t a_size_in_bytes);
